document.addEventListener("DOMContentLoaded", function () {
    function loadProducts() {
        ...
        return {
            man: [
                { image: "https://res.cloudinary.com/dut9om5xu/image/upload/v1756285068/trendy-colour-swatches-collage_uszu0t.jpg", name: "Colorful T-Shirt", price: "150" },
                { image: "https://res.cloudinary.com/dut9om5xu/image/upload/v1756285084/shoes_j8cnpm.jpg", name: "Running Shoes", price: "450" },
                { image: "https://res.cloudinary.com/dut9om5xu/image/upload/v1756285609/shirt_hqewog.jpg", name: "Casual Shirt", price: "300" },
                { image: "https://res.cloudinary.com/dut9om5xu/image/upload/v1756285093/shoes_1_jsaexv.jpg", name: "Formal Shoes", price: "550" },
                { image: "https://res.cloudinary.com/dut9om5xu/image/upload/v1756284075/top-view-composition-different-traveling-elements_ywlggn.jpg", name: "Travel Set", price: "1350" }
            ],
            woman: [
            ...
            kids: [
                { image: "https://res.cloudinary.com/dut9om5xu/image/upload/v1756287482/c0d25c64-7084-4c2c-b0c4-2d7616562996_rzmljj.jpg", name: "Kids Polo", price: "300" },
            ...
            container.insertAdjacentHTML("beforeend", `
                <div class="product col-6 col-md-4 col-lg-2 d-flex flex-column card p-2 m-2" data-section="${sectionId}" data-image="${item.image}">
                    ...
                    <div class="d-flex justify-content-around">
                        ...
                        <button class="btn btn-dark btn-sm remove-product"><i class="bi bi-trash"></i></button>
                    </div>
                </div>
            `);
        });
    ...
    if (form) {
        form.addEventListener("submit", function (e) {
            ...
            Swal.fire({
                ...
                html: `<b>price:</b> ${price}<br><b>name:</b>${name} <br><b>section:</b> ${section} <br>
    ...
    function removeProduct(section, image) {
        ...
        Swal.fire({
            ...
            products[section] = products[section].filter(p => p.image !== image);
            saveProducts(products);

            // Re-render the section
            addProducts(section, products[section]);

            Swal.fire({ title: "Deleted!", text: "Product removed successfully", icon: "success", timer: 1500, showConfirmButton: false });
        });
    }
    ...
    document.body.addEventListener("click", function (e) {
        ...
        if (e.target.closest(".remove-product")) removeProduct(section, image);
    });
});
